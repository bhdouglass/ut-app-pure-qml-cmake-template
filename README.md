# Ubuntu Touch Pure QML CMake App Template

A template to generate apps for Ubuntu Touch that are pure QML apps using
...
'Pure QML App (built using CMake)' option.
...
* Generate the project
    * Run `cookiecutter gh:bhdouglass/ut-app-pure-qml-cmake-template`
